...
function CancelledOrders() {
    return (
        <table className="w-full mt-4 border-collapse overflow-y-hidden">
            ...
            <tbody>
                <TableData jobOrderNo='1' name='Peter Victor Dawis' taskDescription='1pc Bakal' urgency="Medium" requestDate="May 24, 2025" dueDate="May 25, 2025" status='Cancelled' />
                <TableData jobOrderNo='2' name='Danziel Jean Lumactod' taskDescription='1pc Bakal' urgency="Low" requestDate="May 24, 2025" dueDate="May 25, 2025" status='Cancelled' />
            </tbody>
        </table>
    )
}
